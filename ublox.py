...
msg_types = {
    ...
    (CLASS_NAV, MSG_NAV_PVT): UBloxDescriptor('NAV_PVT',
                                              '<IHBBBBBBIiBBBBiiiiIIiiiiiIIH 6B iI',
                                              ['iTOW', 'year', 'month', 'day', 'hour', 'min', 'sec', 'valid', 'tAcc',
                                               ...
                                               'sAcc', 'headAcc', 'pDOP', 'reserved1[6]', 'headVeh', 'reserved2']),
    ...
    (CLASS_TIM, MSG_TIM_DOSC): UBloxDescriptor('TIM_DOSC',  # Only supported with Time & Frequency products
                                               '<B 3B I',  # versions 16 to 22
                                               ['version', 'reserved1', 'value']),
    (CLASS_TIM, MSG_TIM_FCHG): UBloxDescriptor('TIM_FCHG',
                                               '<B 3B IiIIiII',
                                               ['version', 'reserved1', 'iTOW', 'intDeltaFreq', 'intDeltaFreqUnc',
                                                'intRaw', 'extDeltaFreq', 'extDeltaFreqUnc', 'extRaw']),
    (CLASS_TIM, MSG_TIM_SMEAS): UBloxDescriptor('TIM_SMEAS',
                                                '<BBHII',
                                                ['version', 'numMeas', 'reserved1', 'iTOW', 'reserved2'],
                                                'numMeas',
                                                'BBbBiIIiI',
                                                ['sourceId', 'flags', 'phaseOffsetFrac', 'phaseUncFrac', 'phaseOffset',
                                                 'phaseUnc', 'reserved3', 'freqOffset', 'freqUnc']),
    (CLASS_TIM, MSG_TIM_TOS): UBloxDescriptor('TIM_TOS',
                                              '<BBHIHBBBBBBiIIIiIiIiI',
                                              ['version', 'gnssId', 'reserved1', 'flags', 'year', 'month', 'day',
                                               'hour', 'minute', 'second', 'utcStandard', 'utcOffset', 'utcUncertainty',
                                               'week', 'TOW', 'gnssOffset', 'gnssUnvertainty', 'intOscOffset',
                                               'intOscUncertainty', 'extOscOffset', 'extOscUncertainty']),
    (CLASS_TIM, MSG_TIM_TP): UBloxDescriptor('TIM_TP',
                                             '<IIiHBB',
                                             ['towMS', 'towSubMS', 'qErr', 'week', 'flags', 'refInfo']),
    ...
    (CLASS_TIM, MSG_TIM_VCOCAL): UBloxDescriptor('TIM_VCOCAL',
                                                 '<BBB 3B Hi',
                                                 ['type', 'version', 'oscId', 'reserved1', 'gainUncertainty',
                                                  'gainVco']),
